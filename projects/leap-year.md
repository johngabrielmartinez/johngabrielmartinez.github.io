...
labels:
  ...
  - Algorithms
  - Problem Solving
summary: "A Java-based project focused on translating real-world calendar rules into precise conditional logic, emphasizing correctness, edge cases, and algorithmic thinking."
---

<div class="text-center p-4">
  <img width="200px" src="../img/basic-java-pics/gregory2.jpg" class="img-thumbnail" >
</div>
