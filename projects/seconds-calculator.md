...
summary: "A Java program that calculates the total number of seconds based on user-provided hours, minutes, and seconds, focusing on arithmetic logic and user input handling."
---

<div class="text-center p-4">
  <img width="200px" src="../img/basic-java-pics/time2.jpg" class="img-thumbnail" >
</div>
...
- [Seconds Calculator (Java)](https://github.com/johngabrielmartinez/johngabrielmartinez.github.io/tree/main/projects/basic-java)
